...
- [Website features / Fonctionnalités du site web](#website-features--fonctionnalités-du-site-web)
  - [Essential features / Fonctionnalités essentielles](#essential-features--fonctionnalités-essentielles)
    ...
    - [About page / Page à propos](#about-page--page-à-propos)
    - [Contact page / Page de contact](#contact-page--page-de-contact)
    - [Multimedia content / Contenu multimédia](#multimedia-content--contenu-multimédia)
    - [Social media integration / Intégration des réseaux sociaux](#social-media-integration--intégration-des-réseaux-sociaux)
    - [Multi-language support / Support multilingue](#multi-language-support--support-multilingue)
    ...
    - [Cookies consent / Consentement aux cookies](#cookies-consent--consentement-aux-cookies)
  ...
  - [Less essential features / Fonctionnalités moins essentielles](#less-essential-features--fonctionnalités-moins-essentielles)
    - [Search bar / Barre de recherche](#search-bar--barre-de-recherche)
    - [Reviews page / Page des avis](#reviews-page--page-des-avis)
    - [Blog or News section / Blog ou section Actualités](#blog-or-news-section--blog-ou-section-actualités)
    - [Privacy policy / Politique de confidentialité](#privacy-policy--politique-de-confidentialité)
    - [Terms and conditions / Conditions générales d'utilisation](#terms-and-conditions--conditions-générales-dutilisation)
    - [FAQ / FAQ](#faq--faq)
    - [Call To Action (CTA) / Appel à l'action (CTA)](#call-to-action-cta--appel-à-laction-cta)
    - [Chatbot / Chatbot](#chatbot--chatbot)
- [Design and Layout / Conception et mise en page](#design-and-layout--conception-et-mise-en-page)
  - [Branding / Image de marque](#branding--image-de-marque)
  - [UX design / Conception UX](#ux-design--conception-ux)
